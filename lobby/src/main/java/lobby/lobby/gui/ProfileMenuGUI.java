...
public class ProfileMenuGUI {
    ...
    public static void openProfileMenu(Player player, Lobby plugin) {
        ...
        // Create bed effect selection item
        ItemStack effectSelect = new ItemStack(Material.FIREWORK_ROCKET);
        ItemMeta effectMeta = effectSelect.getItemMeta();
        if (effectMeta != null) {
            effectMeta.setDisplayName("§d§lベッド破壊エフェクト");
            ...
            effectSelect.setItemMeta(effectMeta);
        }

        // Place effect selection in slot 15
        gui.setItem(15, effectSelect);
